...
COMMON      := -O2 -mword-relocations -fomit-frame-pointer -ffunction-sections $(ARCH) $(INCLUDE) -D__3DS__ # -Wall
...
run: all
	citra-qt "output/$(TARGET).3dsx"

run_net: all
	$(DEVKITPRO)/tools/bin/3dslink "output/$(TARGET).3dsx"
